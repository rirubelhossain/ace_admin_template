        ...
        <div class="col-xs-12">
            ...
            <form method="post" action="{{route('customer.update',['customer'=>$customer->id])}}"
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-9">
                        <input value="{{old('name',$customer->name)}}" type="text" id="form-field-1"
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-9">
                        <input value="{{old('email',$customer->email)}}" name="email" type="text" id="form-field-2"
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-9">
                        <input value="{{old('phone',$customer->phone)}}" name="phone" type="text" id="form-field-3"
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-9">
                        <select data-value="{{$customer->purchase_info}}" name="purchase_info" id="form-field-5"
                                class="col-xs-10 col-sm-5">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-9">
                        <input value="{{old('price',$customer->price)}}" name="price" type="number" id="form-field-6"
                               step="0.01"
